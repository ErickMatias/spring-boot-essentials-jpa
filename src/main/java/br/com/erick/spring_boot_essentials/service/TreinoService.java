...
import br.com.erick.spring_boot_essentials.database.repository.IExerciciosRepository;
...
public class TreinoService {
    ...
    public void criarTreino(TreinoDto treinoDto) throws NotFoundException, BadRequestException {
        ...
        if (treino != null) {
            throw new BadRequestException("Já existe um trino com esse nome para esse aluno");
        }
